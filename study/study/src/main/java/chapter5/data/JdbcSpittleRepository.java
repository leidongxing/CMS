...
public class JdbcSpittleRepository implements SpittleRepository{
	...
	public List<Spittle> findRecentSpittles() {
		return jdbc.query("select id,message,create_at,latitude,longitude "
